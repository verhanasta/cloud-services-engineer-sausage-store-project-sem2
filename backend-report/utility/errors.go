...
const (
	...
	UserNotFound        = "userNotFound"  // if health not found
...
var errorMessage = map[string]string{
	"invalidUserID":       "invalid health id",
	"internalError":       "an internal error occured",
	"userNotFound":        "health could not be found",
	...
	"userAlreadyExists":   "health already exists",
}
